...
const Home: React.FC = () => {
    return (
        <div id="" className="home-page flex flex-col gap-8 mb-16">
            <div className="home-banner ">
                <div className="home-banner-wrap flex relative">
                    ...
                    <div className="home-banner-opacity bg-white opacity-45 absolute w-full ">
                    </div>
                    <div className="home-text-banner flex flex-col gap-8 absolute  ">
                        <div className="home-banner-text flex gap-2 flex-col">
                            ...
                            <p className="home-banner-text_quality">CHẤT LƯỢNG NHẤT CHO MỌI NGƯỜI</p>
                        </div>
                        <div className="home-banner-button flex gap-6">
                            <div className="banner-button_explore">
                                <input type="button" className="bg-white px-6 py-4 rounded-full font-bold hover:opacity-50 hover:cursor-pointer duration-700 ease-linear" value="Khám phá cửa hàng" />
                            </div>
                            <div className="banner-button_contact">
                                <input type="button" className="bg-white px-6 py-4 rounded-full font-bold hover:opacity-50 hover:cursor-pointer duration-700 ease-linear" value="Liên hệ chúng tôi" />
                            </div>
                        </div>
                    </div>
