  ...
  const orders: OrderItemProps[] = [
    {
      ...
      productList: [
        ...
        { name: 'Váy', size: 'XL', color: 'Xám', quantity: 4, price: '200.000' },
        { name: 'Quần', size: 'XL', color: 'Xám', quantity: 10, price: '400.000' },
        { name: 'Đầm', size: 'XL', color: 'Xám', quantity: 1, price: '300.000' }
      ],
    },
    {
      date: '11/8/2024',
